...
call ntpl.setBlock("MAIN", array("FILE_HIDDEN", "FILE_HIDDEN2", "FILE_HIDDEN3", "BTN_REPLY"))
...
If IsNull(FI_File2) Or FI_File2="" Then
	ntpl.tplBlockDel("FILE_HIDDEN2")
Else
	ntpl.tplParseBlock("FILE_HIDDEN2")
End If

If IsNull(FI_File3) Or FI_File3="" Then
	ntpl.tplBlockDel("FILE_HIDDEN3")
Else
	ntpl.tplParseBlock("FILE_HIDDEN3")
End If
...
ntpl.tplAssign array(   _
	...
	,array("File2", FI_File2 ) _
	,array("File3", FI_File3 ) _
	,array("Id", FI_Id ) _
	...
	,array("downloadUrl2", DOWNLOAD_BASE_PATH & FI_File2 ) _
	,array("downloadUrl3", DOWNLOAD_BASE_PATH & FI_File3 ) _
...
Sub getData()
	...
	"	,A.[File2] " &_
	"	,A.[File3] " &_
	"	FROM [smileh_kfba].[dbo].[SP_BOARD] A " &_
