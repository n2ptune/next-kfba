...
call ntpl.setBlock("MAIN", array("HIDDEN_DATA" , "HIDDEN_DATA_FILE", "HIDDEN_DATA_FILE2", "HIDDEN_DATA_FILE3"))
...
If IsNull(FI_File2) Or FI_File2 = "" Then 
	ntpl.tplBlockDel("HIDDEN_DATA_FILE2")
Else
	ntpl.tplParseBlock("HIDDEN_DATA_FILE2")
End If

If IsNull(FI_File3) Or FI_File3 = "" Then 
	ntpl.tplBlockDel("HIDDEN_DATA_FILE3")
Else
	ntpl.tplParseBlock("HIDDEN_DATA_FILE3")
End If
