    ...
    function html5Upload() {	
    	...
    	sUploadURL= 'http://kfba.smileh.co.kr/_smarteditor/popup/quick_photo/FileUploader_html5.asp'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : 'http://'+(document.domain)+'/_smarteditor/popup/quick_photo/FileUploader.asp',	//샘플 URL입니다.
