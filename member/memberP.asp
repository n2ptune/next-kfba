...
Dim UserZip     : UserZip      = RequestSet("UserZip"     , "POST" , "")
...
Sub Insert()
	...
	with objCmd
		...
		.Parameters.Append .CreateParameter( "@UserZipcode" ,adChar        , adParamInput, 6          , UserZip )
...
Sub Update()
  ...
  '핸드폰 번호 공백 삭제
  SQL = "UPDATE [dbo].[SP_USER_MEMBER] " &_
        "SET UserHphone1 = '010' " &_
        "WHERE UserHphone1 = '010 '"
